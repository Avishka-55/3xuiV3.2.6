...
install_x-ui() {
    ...
    # Download resources - pinned to v3.2.6
    tag_version="v3.2.6"
    echo -e "Installing pinned version: ${tag_version}..."
    ...
    curl -4fLRo /usr/bin/x-ui-temp https://raw.githubusercontent.com/Avishka-55/3xuiV3.2.6/master/x-ui.sh
    if [[ $? -ne 0 ]]; then
